...
import { Animated, BackHandler, Dimensions, Easing, findNodeHandle, FlatList, Image, RefreshControl, ScrollView, StyleSheet, Text, TouchableOpacity, UIManager, View } from 'react-native';
